...
public class A3_13 {
    ...
    /*
    * (Financial application: compute taxes) Listing 3.5, ComputeTax.java,
    * gives the source code to compute taxes for single filers.
    * Complete this program to compute taxes for all filing statuses.
    * */

    public static void main (String[] args) {

        System.out.println("This tool is to compute the tax.\n");
        ...
        System.out.println("(0-single filer, 1-married jointly or " +
                ...
                "household) \nEnter the filing status (input 0 or 1 or 2 or 3): ");
